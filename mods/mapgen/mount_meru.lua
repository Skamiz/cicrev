...
local XMIN = -100 -- Area for the meru mountain spawn
local XMAX = 100
local ZMIN = -100
local ZMAX = 100

local BASRAD = 64 -- Average radius at y = -32
local HEIGHT = 500 -- Approximate height measured from y = -32
local CONVEX = 0.6 -- Convexity. <1 = concave, 1 = conical, >1 = convex
local VOID = 1.4 -- Void threshold. Controls size of central void
