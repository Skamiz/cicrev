	...
	for z = minp.z, maxp.z do
		for y = minp.y, maxp.y do
			for x = minp.x, maxp.x do
				...
				local noise_index_3d = (z - minp.z) * side_lenght * side_lenght + (y - minp.y) * side_lenght + (x - minp.x) + 1
				local noise_index_2d = (z - minp.z) * side_lenght + (x - minp.x) + 1
