...
--[[-- uncoment to print all minetest variables available in the mapgen env
local t = {}
...
-- check wheter we are in the mapgen environment
local in_mapgen_env = not minetest.after
--]]
...
minetest.register_on_generated(generate_chunk)
-- minetest.register_on_generated(function(vm, minp, maxp, chunkseed) end)
