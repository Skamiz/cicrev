	...
	for x = minp.x, maxp.x do
		for y = minp.y, maxp.y do
			for z = minp.z, maxp.z do
                ...
                if nv_3d - (y / (20 * ((nv_terrain_height + 1)/2))) + nv_terrain_height > 0 then
                    if y < 2 then
                        data[vi] = c_sand
                        if y < -3 then
                            data[vi] = c_gravel
                    ...
                    if nv_3d_1 - ((y + 1) / (20 * ((nv_terrain_height + 1)/2))) + nv_terrain_height > 0 then
                        data[vi] = c_dirt
                    end
                    if nv_3d_4 - ((y + 4) / (20 * ((nv_terrain_height + 1)/2))) + nv_terrain_height > 0 then
                        data[vi] = stone
                    end
                end
			end
